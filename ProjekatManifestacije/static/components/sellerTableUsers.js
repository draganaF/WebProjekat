Vue.component("sellerTableUsers", {
    name: "sellerTableUsers",
    data: function () {
      return {
        users:[],
        pretraga:"",
    ...
    methods: {
        refresh(){
            axios.get('/sellerManifestationsUsers', {params:{korisnickoIme:this.kIme}})
		    .then(response => {
        ...
        search(){
            ...
            if(this.tip == "" && this.pretraga ==""){
                ...
                axios.get('/searchUser', {params:{pretraga:this.pretraga, korisnickoIme:this.kIme, tip:this.tip}})
                .then(response => {
                for(var i =0;i< response.data.length;i++){
                    var user = {};
                    user.name = response.data[i].ime;
    ...
    ` <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card col-md-11">
                <div class="card-header row justify-content-center"  style="background-color:#1fb579; color:white">Kupci</div>
                <div class="card-body">
                <div class="row">
                    <div class="col-4">
                        <form @submit="search">
